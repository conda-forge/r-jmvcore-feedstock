About r-jmvcore-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-jmvcore-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1272&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-jmvcore-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-jmvcore` can be installed with `conda`:
...
```
mamba install r-jmvcore
```

It is possible to list all of the versions of `r-jmvcore` available on your platform with `conda`:
...
```
mamba search r-jmvcore --channel conda-forge
```
...
mamba repoquery search r-jmvcore --channel conda-forge

# List packages depending on `r-jmvcore`:
mamba repoquery whoneeds r-jmvcore --channel conda-forge

# List dependencies of `r-jmvcore`:
mamba repoquery depends r-jmvcore --channel conda-forge
```
